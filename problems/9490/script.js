(() => {
 ...
 const PROBLEM={"number":"9490","title":"풍선팡","autoplayMs":350,"defaultSampleId":"one","sourceSteps":[{"text":"max_pang = 0","types":"init"},{"text":"dr = [0, 1, 0, -1]","types":"dr"},{"text":"dc = [1, 0, -1, 0]","types":"dc"},{"text":"for r in range(N):","types":"row"},{"text":"for c in range(M):","types":"col"},{"text":"c_pang = balloons[r][c]","types":"center"},{"text":"for i in range(4):","types":"direction"},{"text":"for j in range(1, balloons[r][c]+1):","types":"distance"},{"text":"nr = r + dr[i]*j","types":"next-row"},{"text":"nc = c + dc[i]*j","types":"next-col"},{"text":"if (0 <= nr < N) and (0 <= nc < M):","types":"bounds"},{"text":"c_pang += balloons[nr][nc]","types":"add"},{"text":"if max_pang < c_pang:","types":"best-check"},{"text":"max_pang = c_pang","types":"best"},{"text":"print('#{} {}'.format(tc, max_pang))","types":"output"}],"samples":[{"id":"one","label":"샘플 1","value":"1\n3 5\n2 1 1 2 2\n2 2 1 2 2\n2 2 1 1 2"},{"id":"sample2","label":"샘플 2","value":"1\n5 5\n3 4 1 2 3\n3 4 1 3 2\n2 3 2 4 1\n1 4 4 1 3\n2 2 3 4 4"},{"id":"sample3","label":"샘플 3","value":"1\n5 8\n1 3 4 4 4 4 3 3\n4 1 2 4 3 1 4 4\n4 1 4 4 1 4 2 1\n3 2 4 2 1 1 2 1\n4 4 1 4 4 2 2 2"},{"id":"all","label":"전체 샘플","value":"3\n3 5\n2 1 1 2 2 \n2 2 1 2 2 \n2 2 1 1 2 \n5 5\n3 4 1 2 3 \n3 4 1 3 2 \n2 3 2 4 1 \n1 4 4 1 3 \n2 2 3 4 4 \n5 8\n1 3 4 4 4 4 3 3 \n4 1 2 4 3 1 4 4 \n4 1 4 4 1 4 2 1 \n3 2 4 2 1 1 2 1 \n4 4 1 4 4 2 2 2"}]};
